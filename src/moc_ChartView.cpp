/****************************************************************************
** Meta object code from reading C++ file 'ChartView.hpp'
**
...
#error "The header file 'ChartView.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 14), // "showHideToggle"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "ChartView\0showHideToggle\0"
};
...
void ChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showHideToggle(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ChartView::staticMetaObject = {
    { &QWebView::staticMetaObject, qt_meta_stringdata_ChartView.data,
